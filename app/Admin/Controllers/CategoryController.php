...
class CategoryController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->column('category_name_ar', __('category Name Arabic'));
        ...
        $grid->filter(function ($filter) {
            ...
            $filter->like('category_name_ar', 'category Name Arabic');
    ...
    protected function form()
    {
        ...
        $form->text('category_name_ar', __('category Name Arabic'))->rules(function ($form) {
            return 'required|max:100';
        });
