...
class ServiceController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->column('service_name_ar', __('Service Name Arabic'));
        $grid->column('description', __('Description'));
        $grid->column('description_ar', __('Description Arabic'));
    ...
    protected function form()
    {
        ...
        $form->text('service_name_ar', __('Service Name Arabic'))->rules(function ($form) {
            return 'required|max:100';
        });
        ...
        $form->image('image', __('Image'))->rules('required')->uniqueName()->move('services')->rules('required');
