...
class FaqController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->column('question_ar', __('Question Arabic'));
        $grid->column('answer', __('Answer'));
         $grid->column('answer_ar', __('Answer Arabic'));
    ...
    protected function form()
    {
        ...
        $form->text('question_ar', __('Question Arabic'))->rules(function ($form) {
            return 'required';
        });
        $form->textarea('answer', __('Answer'))->rules(function ($form) {
            return 'required';
        });
         $form->textarea('answer_ar', __('Answer Arabic'))->rules(function ($form) {
            return 'required';
        });
