...
class PromoCodeController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->column('promo_name_ar', __('Promo Name Arabic'));
        $grid->column('description', __('Description'));
        $grid->column('description_ar', __('Description_Arabic'));
    ...
    protected function form()
    {
        ...
        $form->text('promo_name_ar', __('Promo name Arabic'))->rules(function ($form) {
            return 'required|max:100';
        });
